...
class Grammar{
    ...
    * variables, terminals, rules, and a start variable. It then uses the CYK algorithm provided by the Sipser textbook
    ...
    */
    void Grammar:: read(){
        ...
        //while we are not at the end of the file and out boolean is still false
       ...
       //print this to indicate that we are printing the rules
        ...
        //create an empty string 
            ...
            if(inputLine == ""){ //if the input line is empty, we need to check if it has an epsilon allowing for that empty string
                ...
                int numRows = 300 * inputLine.length(); // we are going to intialize rows and columns for our table. this is kind of a large table but we didn't want to end up with an error due to our table being too smal
                ...
                for(int l = 2; l <= inputLine.length(); l++){ //line 6
                    ...
                    for(int i = 0; i <= inputLine.length() - l; i++){ //line 7
                        ...
                        int j = i + l - 1; //line 8
                        //terates over all possible split positions `k` within the current substring from `i` to `j - 1`.
                ...
                if(hasS){ //if it has S accpet
                    cout << "Accept" << endl;
                } 
                else { //if it doesnt, reject
                    cout << "Reject" << endl;
                }
            }
        }
